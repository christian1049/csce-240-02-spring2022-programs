...
void readFile() {
    ...
    double num3;
    double result;
    string out_file_name = "C:\\Users\\chris\\OneDrive\\Desktop\\CSCE240\\csce-240-02-spring2022-programs\\doc\\output.txt";
    string decision;

    ifstream in_stream;
    ofstream out_stream(out_file_name);
    in_stream.open("C:\\Users\\chris\\OneDrive\\Desktop\\CSCE240\\csce-240-02-spring2022-programs\\doc\\input.txt");
